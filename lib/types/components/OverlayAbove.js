...
export function OverlayAbove({ children, maxHeight, }) {
    return (_jsx(Box, { position: "absolute", bottom: "100%", left: 0, right: 0, flexDirection: "column", justifyContent: "flex-end", overflow: "hidden", opaque: true, ...(maxHeight === undefined ? {} : { maxHeight }), children: children }));
}
